...
public class RipsCreator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File directorio=new File("C:\\RIPS\\"); 
        directorio.mkdir(); 
        int TipoDoc = 0;
        int DatoDos = 0;
        String Factura = "";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                fwriter.close();
                jLabel8.setVisible(false);
                JOptionPane.showMessageDialog(null,"Se ha Generado Correctamente");
            }
            
            an.close();

        } catch (Exception ex) {
            System.out.println("Se ha presentado el error " + ex.toString() + ex.getMessage());
        }
